...
<head>
<?php 
echo "<title>Student Registration @ $banner</title>
...
<body >
      ...
      <header>
          <div id='welcome_to_school'>
            <?php echo "STUDENT REGISTRATION AT $banner" ;?> 
         </div>
...
<div class="login_form_sms_header">
    <span>PLEASE ENTER IN THE FORM BELOW THE SCHOOL CODE AND THE PIN ISSUED TO YOU AT THE TIME OF PAYMENT</span>
</div>
      <div class='hold_sms_login_form'>
  
<span class="login_form_sms">
    <form  role='form' action='validatepin_student.php' method='post'>
